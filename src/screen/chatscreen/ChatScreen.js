        ...
        <View style={styles.containerScreen}>
            <ScrollView style={{ flex: 1 }}>
                <View style={styles.header}>
                    <Image style={styles.avatar} source={{ uri: 'https://mir-s3-cdn-cf.behance.net/project_modules/1400_opt_1/d07bca98931623.5ee79b6a8fa55.jpg' }} />
                ...
                <View style={styles.wraperTextInputSearch}>
                    <TextInput
                        ...
                        placeholder='Search...'
                    />
                    <Ionicons style={styles.iconSearch} name='search' size={24} color='#6c757d' />
                </View>
                <View style={{ height: 15 }} />
                <ScrollView style={{ marginLeft: 20 }} horizontal={true} showsHorizontalScrollIndicator={false}>
                    {
                        dataUser.map((user, index) => (
                            <Pressable key={index} style={{ flexDirection: 'column', marginRight: 15, alignItems: 'center', gap: 5 }}>
