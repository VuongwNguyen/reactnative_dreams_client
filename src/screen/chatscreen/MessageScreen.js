        ...
        <View style={{ flex: 1 }}>
            <View style={MessageStyles.headerChatContainer}>
                <View style={MessageStyles.headerChat}>
                    <View style={MessageStyles.headerLeft}>
                        ...
                        <Image style={MessageStyles.avatar} source={{ uri: 'https://mir-s3-cdn-cf.behance.net/project_modules/1400_opt_1/d07bca98931623.5ee79b6a8fa55.jpg' }} />
                        <View>
                            ...
                            <View key={index}>
                                {
                                    message.idUser === yourMessage.idUser ?
                                        <View style={MessageStyles.wraperMessage}>
                                            <MessageRight>
                                                {
                                                    message.messageText && <Text style={MessageStyles.textMessageRight}>{message.messageText}</Text>

                                                }
                                                {
                                                    message.messageImage && <GridImage arrImages={message.messageImage} />
                                                }
                                            </MessageRight>
                                            <Text style={MessageStyles.textCreateAtRight}>{message.createdAt}</Text>
                                        </View>
                                        :
                                        <View style={MessageStyles.wraperMessage}>
                                            <MessageLeft style={MessageStyles.wraperMessage}>
                                                {
                                                    message.messageText && <Text style={MessageStyles.textMessageLeft}>{message.messageText}</Text>
                                            ...
                                            <Text style={MessageStyles.textCreateAtLeft}>{message.createdAt}</Text>
                                        </View>
                                }
                            </View>
                        ))
            ...
            <View style={MessageStyles.footerChat}>
                ...
                <View style={MessageStyles.wraperTextInput}>
                    <TextInput
                        style={[MessageStyles.textInputMessage, { height: Math.max(50, height) }]}
                        value={message}
                    ...
                    />
                    <Pressable onPress={() => setMessage('')} style={MessageStyles.buttonSendMessage}>
                ...
                </View>
                {
                    message.length > 0 ?
                        ...
                        <>
                            <Pressable>
                                <Image source={require('../../../assets/icons/keyboardvoice.png')} />
                            </Pressable>
                        </>
                }
            </View>
...
const DataMessage = {
    ...
    messages: [
        {
            idUser: 1,
            messageText: 'Hello, how are you? Hi! I’,m fine thank you and you Hello, how are you? Hi! I’,m fine thank you and you',
            messageImage: [
