...
export const Assets = {
  icons: {
    ...
    edu: require(uriIcons + 'graduation.png'),
    dob: require(uriIcons + 'birthday.png'),
    zone: require(uriIcons + 'location.png'),
    natl: require(uriIcons + 'earth.png'), // những chỗ dùng icon earth thì đổi thành public nha
    gender: require(uriIcons + 'gender.png'),
    fullname: require(uriIcons + 'user.png'),
    job: require(uriIcons + 'job.png'),
    htown: require(uriIcons + 'htown.png'),
