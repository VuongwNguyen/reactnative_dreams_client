            ...
            <View style={styles.commentRow}>
                ...
                <View style={styles.commentRowContent}>
                    <View style={styles.commentColumn}>
                        ...
                        <Text style={styles.textReply} onPress={handleRefInput}>{t("postDetailScreen.reply")}</Text>
                    </View>
                </View>
                ...
                comment.replies.length > 0 && (
                    <>
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                <View>
                                    <CommetItem comment={item} level={level + 1} />
                                </View>
                            )}
                        ...
                        />
                        {
                            visibleReplies < comment.replies.length && (
                                <TouchableOpacity style={styles.button} onPress={handleViewMoreReplies}>
